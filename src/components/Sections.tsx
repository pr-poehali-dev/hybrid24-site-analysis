  ...
  return (
    <>
      <section 
        ...
        style={{
          backgroundImage: 'url(https://cdn.poehali.dev/files/669db721-6d97-472f-a220-81cb62889bd8.png)',
        }}
      >
        <div className="absolute inset-0 bg-gradient-to-r from-white/98 via-white/95 to-white/75"></div>
